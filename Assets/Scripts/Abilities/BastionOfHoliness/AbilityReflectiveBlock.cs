...
public class AbilityReflectiveBlock : Ability
{
    ...
    {
        string str = "Blocking increases the %DR by 50. While blocking FP regeneration is set to zero. Reflective blocking returns all projectiles to the originator. Each projectile reduces your current FP by 30.";
