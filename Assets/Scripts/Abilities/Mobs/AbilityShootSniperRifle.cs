...
public class AbilityShootSniperRifle : Ability
{
    public AbilityShootSniperRifle()
    {
    ...
    {
        return "Attack the enemy from range for 15 physical dmg.";
    }
    ...
    {
        string str = String.Format("{0} shoots a sniper rifle. ", actor.name);
