...
public class AbilityShootRifle : Ability
{
    public AbilityShootRifle()
    {
        id = AbilityTypeEnum.abilShootRifle;
        stdName = "Shoot Rifle";
        passive = false;
    ...
    {
        return "Attack the enemy from range for 10 physical dmg.";
    }
    ...
    {
        string str = String.Format("{0} shoots a rifle. ", actor.name);
        BoardManager.instance.msgLog.PlayerVisibleMsg(actor.x, actor.y, str);

        Ability.ShootProjectile(actor, target.mob, new Color32(100, 100, 100, 255),
