...
public class AbilityVorpaniteClaws : Ability
{
    public AbilityVorpaniteClaws()
    {
    ...
    {
        return "Attack the enemy in melee for 5 Physical dmg and 5 Vorpanite dmg.";
    }
    ...
    public override void AbilityInvoke(Mob actor, TargetStruct target)
    {
        ...
        dmg += Mob.InflictDamage(actor, target.mob, 5, DmgTypeEnum.Vorpanite, null);
